...
const letsPlay = (userChoice) => {
	...
	if (userChoice === "rock") {
		...
		document.getElementById("userChoice").src = "./rock.png";
	} else if (userChoice === "paper") {
        document.getElementById('myChoice').style.border = "20px solid #ffa943";
		document.getElementById("userChoice").src = "./paper.png";
	} else if (userChoice === "scissor") {
        document.getElementById('myChoice').style.border = "20px solid #bd00ff";
		document.getElementById("userChoice").src = "./scissor.png";
	}
...
const play = (userChoice) => {
	...
	if (computerChoice === "rock") {
        ...
        document.getElementById("loadingDone").src = "./rock.png";
	} else if (computerChoice === "paper") {
        document.getElementById('pcChoice').style.border = "20px solid #ffa943";
        document.getElementById("loadingDone").src = "./paper.png";
	} else if (computerChoice === "scissor") {
        document.getElementById('pcChoice').style.border = "20px solid #bd00ff";
		document.getElementById("loadingDone").src = "./scissor.png";
	}
